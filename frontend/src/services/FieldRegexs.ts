...
export class FieldDescriptions {
    ...
    public static readonly username: string = "Il nome utente deve cominciare con una lettera ed essere lungo almeno 3 caratteri alfanumerici, con eventualmente i caratteri speciali '_- '.";
