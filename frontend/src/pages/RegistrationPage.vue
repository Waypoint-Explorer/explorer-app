  ...
  <main>
    ...
    <div class="p-formgroup-inline">
      ...
      <div class="p-field">
        ...
        <calendarComp id="calendar" v-model="date" view="year" dateFormat="yy" :minDate="minDate" :maxDate="maxDate" :manualInput="false" showIcon />
      </div>
      ...
      <!--      <p class="paragraph">Registrandoti, accetti l'
        <RouterLink :style="{ color: '#0D47A1', 'margin-top': '30px' }" :to="{ name: 'info' }">informativa sulla privacy</RouterLink>.
      </p>-->
      <buttonComp type="button" label="Conferma" @click.prevent="registerUser"/>
    </div>
  </main>
</template>
