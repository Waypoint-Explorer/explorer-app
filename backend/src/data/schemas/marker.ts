...
interface Marker {
    ...
    points?: number,
    /** The unique dynamic codes generated by this marker */
    dynamic_codes?: string[],
    /** The status of this marker */
    status?: number,
}
...
const MARKER_SCHEMA = new Schema<Marker>({
    ...
    dynamic_codes: { type: Array(SchemaTypes.String), required: false},
    status: { type: SchemaTypes.Number, required: false},
});
